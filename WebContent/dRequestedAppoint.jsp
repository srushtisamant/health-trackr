...
//                  String dreg = "Select * from dregister where duname = '"+user+"'";
...
//                  }
//                  String str = "Select * from bookappointment where doctorname = '"+dname+"'";
...
<%--               %> --%>
<!--               <form method="post" action="DReqApp"/> -->
<!--               <th>HospitalName</th><th>Dieases</th><th>AppointmentDate</th><th>TimeSlot</th><th>OtherDetails</th><th>UserName</th><th>DoctorName</th><th>Approve</th> -->
<!--               <tr> -->
<!--                   <td> -->
<%--                       <input type="text" name ="hname" value="<%= rss.getString(1)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                      <td> -->
<%--                       <input type="text" name ="dieases" value="<%= rss.getString(3)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                      <td> -->
<%--                       <input type="text" name ="adate" value="<%= rss.getString(4)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                      <td> -->
<%--                       <input type="text" name ="tslot" value="<%= rss.getString(5)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                      <td> -->
<%--                       <input type="text" name ="other" value="<%= rss.getString(6)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                     <td> -->
<%--                       <input type="text" name ="uname" value="<%= rss.getString(7)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                       <td> -->
<%--                       <input type="text" name ="dname" value="<%= rss.getString(2)%>" readonly="true"> --%>
<!--                   </td> -->
<!--                   <td> -->
