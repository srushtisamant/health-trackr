  ...
  <div class="container body">
    ...
    <div class="main_container">
     ...
     String user = (String)session.getAttribute("user");
		...
		Query query = ses.createQuery("from bean.BookAppointment where username='"+user+"'");
		List<BookAppointment> li = query.list();
		for(Iterator<BookAppointment> it= li.iterator();it.hasNext();)
		{
			BookAppointment book = it.next();
			stat = book.getStatus();
			bdate = book.getAppdate();
			bTime = book.getTimeslot();
		}
		if(stat.equals(status))
		{
			out.println("Your Appointment has been Confiremed with given Date : " +bdate+ " Time in between " +bTime);
		}
            %>
