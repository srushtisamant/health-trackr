...
<%@page import="model.AppointmentDaoImpl"%>
<%@page import="java.util.List"%>
<%@page import="bean.BookAppointment"%>
<%@page import="util.Database,java.sql.*,java.util.Date"%>
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
          ...
          <table border="1" align="center">
              ...
              <th>PatientName</th><th>HospitalName</th><th>Dieases</th><th>Date</th><th>Time</th><th>DoctorName</th><th>Status</th>
              <%
              	List<BookAppointment> li = AppointmentDaoImpl.viewAppointmentHosp("Approved");
              	for(Iterator<BookAppointment> it = li.iterator();it.hasNext();)
                {
              		BookAppointment book = it.next();
                %>
                <tr>
                <td><%= book.getUsername() %></td>
                <td><%= book.getHospitalname() %></td>
                <td><%= book.getDiesease() %></td>
                <td><%= book.getAppdate() %></td>
                <td><%= book.getTimeslot() %></td>
                <td><%= book.getDoctorname() %></td>
                <td><a href="UpdateAppointment.jsp?<%=book.getBid()%>"><%= book.getStatus() %></a></td>
                </tr>
                <%
                               }
