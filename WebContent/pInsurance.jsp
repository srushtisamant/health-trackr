...
//       String str = "Select * from insurance where user = '"+user+"'";
//       ResultSet rss = stmt.executeQuery(str );
//       while(rss.next())
//                    {
<%--           %> --%>
<!--           <th>InsComp</th><th>CompContact</th><th>InsuranceType</th><th>HInsurType</th><th>ThirdPartyInsu</th><th>PolicyNo</th><th>PremiumAmount</th><th>PolicyStartDate</th><th>PolicyEndDate</th><th>TotalInsAmount</th><th>SumAssAmnt</th><th>PrDueDate</th> -->
<!--               <tr> -->
<!--                   <td> -->
<%--                       <%= rss.getString(2) %> --%>
<!--                   </td> -->
