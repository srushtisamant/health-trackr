		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<form action="AppointmentServlet" method="post" class="appointment-wrap animate-box">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="subject" name="contact" class="form-control" placeholder="Your Contact Number">
							</div>
						</div>
