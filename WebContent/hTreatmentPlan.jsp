                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"> Treatment plan </h3>
                            </div>
                            <div class="panel-body">
                               <div class="container">
                                    <div class="row">
                                                    <div class="col-md-6 form-group has-success">  <br>
                                                         <input type="text"  placeholder="Patient name" class="form-control"><br>
                                                         <select class="form-control" name="medname" color="green">
                                                                <option> Drug name</option>
                                                            </select><br>
                                                        <input type="text"  placeholder="No of Day" class="form-control"><br>
                                                        <div class="col-md-6 form-group has-success">
                                                            <textarea class="form-control" placeholder="Notes"></textarea>
                                                        </div>
                                                        <div class="col-md-6 form-group has-success">
                                                            <textarea class="form-control" placeholder="Advice"></textarea>
                                                        </div>
                                                        
                                                       
                                        
                                                         <input type="text" name="city" placeholder="Doctor name" class="form-control"><br>
