			...
			<div class="row">
				<div class="col-md-8 image-content">
					<div class="doctor animate-box">
						...
						<h2><a href="doctors-single.jsp">Dr. Beatrice Prior</a></h2>
						...
						<div class="contact-info">
							...
							<p><i class="icon-paperplane"></i><a href="#"> yoursite@info.com</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-4 sticky-parent">
					<div id="sticky_item">
						...
						<p class="btn-big"><a href="appointment.jsp" class="btn btn-primary">Make an Appoinment</a></p>
					</div>
				</div>
			</div>
		</div>
