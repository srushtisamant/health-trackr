    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
          ...
          <div class="col-md-12">
              <br><br><br>
              <div class="col-md-6">
                     <h2><b><center>Appointments</center></b></h2>
                     <
              ...
              try
                 ...
                 String str = "Select * from dreqapp where username = '"+user+"'";
              ...
              %> 
              <th>HospitalName</th><th>Dieases</th><th>Appointment Date</th><th>Time Slot</th><th>DName</th>
              <tr>
                  <td>
                      <%= rss.getString(1) %>
                  </td>
           ...
           --%>
              ...
              <div class="col-md-6">
               <h2><b><center>Latest Notifications</center></b></h2>
  
              </div>
              <br>    <br>
              <div class="col-md-12">
              <div class="col-md-6">
              <h2><b><center>Current Medicines</center></b></h2>
