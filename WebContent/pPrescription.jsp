...
<%@page import="java.sql.*,util.Database,model.*,bean.*,org.hibernate.*" %>
<%!
   String user="";
   String fname="";
%>
...
<body class="nav-md">
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
            ...
            <div class="" style="margin: 8px 5px" id="box_display">
 ...
 try
 {
 	...
 	Query query = ses.createQuery("from bean.Prescription where user = '"+user+"'");
 	List<Prescription> li = query.list();
 	for(Iterator<Prescription> it = li.iterator();it.hasNext();)
    {
 		Prescription pr = it.next();
          %>
          <th>Dieases</th><th>MedicieneType</th><th>MedicineName</th><th>Dosage</th><th>Quantity</th><th>Remark</th><th>DoctorName</th><th>PrecDate</th>
              <tr>
 ...
 }catch(Exception e)
 {
           ...
           %>
                  ...
                  <div class="popup_main_body8 clearfix">
               
            </div>
            <div id="popup_fotter_body8" class="popup_fotter_body8 clearfix">
                <div id="popup_fotter_docname"></div>
                <div id="popup_fotter_sign"></div>
            </div>
</div>
 </div>
