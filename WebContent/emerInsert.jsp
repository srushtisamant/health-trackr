  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
          ...
          <form method="post" action="EmergencyControl">
                                                    <div class="col-md-6 form-group has-success">  <br>
                                                         <br>
                                                         <input type="text"  placeholder="Cases" class="form-control" name="cases"><br>
                                                        <input type="text"  placeholder="Area" class="form-control" name="area"><br>
                                                        <input type="text"  placeholder="SubArea" class="form-control" name="subarea"><br>
                                                        <input type="text"  placeholder="Hospital" class="form-control" name="hospital" value="<%= session.getAttribute("user")%>" readonly="true"><br>
