			...
			<div class="row">
				<div class="col-md-4">
					<div class="blog-entry">
						...
						<div class="desc">
							<h3><a href="blog.jsp">Here's why yoga is best for your health</a></h3>
<!-- 							<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p> -->
				...
				<div class="col-md-4">
					<div class="blog-entry">
						...
						<div class="desc">
							<h3><a href="blog.jsp">live better get to know your medical technology</a></h3>
<!-- 							<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p> -->
							<p><a href="#">Read more <i class="icon-arrow-right3"></i></a></p>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="blog-entry">
						...
						<div class="desc">
							<h3><a href="blog.jsp">Eating apple is the source of energy</a></h3>
<!-- 							<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p> -->
							<p><a href="#">Read more <i class="icon-arrow-right3"></i></a></p>
						</div>
					</div>
