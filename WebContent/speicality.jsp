                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                               <div class="container">
                                    <div class="row">
                                        <form method="post" action="SpecialityControl">
                                                    <div class="col-md-6 form-group has-success">  <br>
                                                        <input type="text"  placeholder="Hospital name" class="form-control" name = "hname" value="<%= session.getAttribute("user")%>" readonly="true"><br>
                                                         <br>
                                                         <input type="text"  placeholder="Spceiality Mandotory" class="form-control" name="sp1"><br>
                                                        <input type="text"  placeholder="Spceiality optional" class="form-control" name="sp2"><br>
                                                        <input type="text"  placeholder="Spceiality optional" class="form-control" name="sp3"><br>
                                                        <input type="text"  placeholder="Spceiality optional" class="form-control" name="sp4"><br>
                                                        <input type="text"  placeholder="Spceiality optinal" class="form-control" name="sp5"><br>
