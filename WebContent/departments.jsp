							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="loc">
										...
										<p><a href="#">Gat No 228,Gangapuri M.I.D.C Road ,
										Wai </a></p>
									</div>
								</div>
							</div>
						...
						<div class="col-xs-8">
							<div class="menu-1">
								<ul>
									...
									<li class="has-dropdown">
										<a href="departments.jsp">Login/Sign Up</a>
										<ul class="dropdown">
											<li><a href="hlogin.jsp">Hospital</a></li>
											<li><a href="plogin.jsp">Doctor</a></li>
											<li><a href="dlogin.jsp">Patient</a></li>
										</ul>
									</li>
									<li class="has-dropdown">
			...
			<div class="row">
				<div class="department-wrap animate-box">
					...
					<div class="grid-2 col-md-6">
						<div class="desc">
							<h2><a href="departments-single.jsp">Plastic Surgery Department</a></h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,</p>
							<div class="department-info">
								<div class="block">
									<h2><a href="doctors-single.jsp">Paul Merriweather</a></h2>
									<span>Head Department</span>
								</div>
								<div class="block">
									<h2><a href="departments-single.jsp">Department info</a></h2>
									<span>Block B, 3rd floor</span>
								</div>
								<div class="block">
									<h2><a href="doctors.jsp">Find a Doctor</a></h2>
									<span>See doctors in this department</span>
								</div>
								<div class="block">
									<h2><a href="appointment.jsp">Request an appointment</a></h2>
				...
				<div class="department-wrap animate-box">
					...
					<div class="grid-2 col-md-6 col-md-pull-6">
						<div class="desc">
							<h2><a href="departments-single.jsp">Dental Department</a></h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,</p>
							<div class="department-info">
								<div class="block">
									<h2><a href="doctors-single.jsp">Paul Merriweather</a></h2>
				...
				<div class="department-wrap animate-box">
					...
					<div class="grid-2 col-md-6">
						<div class="desc">
							<h2><a href="departments-single.jsp">Psychological Department</a></h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,</p>
							<div class="department-info">
								<div class="block">
									<h2><a href="doctors-single.jsp">Paul Merriweather</a></h2>
